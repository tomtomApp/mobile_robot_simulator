...
class Path_Publisher():
    def __init__(self):
        ...
        self.csv_data = pd.read_csv("/home/tomjetson/catkin_ws/src/gnss_imu_odom_eskf/gnss_path/gnss_tukuba1119.csv")
    ...
    def get_poses_from_csvdata(self):
        ...
        for index in range(len(self.csv_data)):
            ...
            temp_pose.pose.position.x = self.csv_data["x"][index] * 0.8
            temp_pose.pose.position.y = self.csv_data["y"][index] * 0.8
